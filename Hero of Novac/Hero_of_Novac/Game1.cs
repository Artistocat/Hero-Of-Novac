...
namespace Hero_of_Novac
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Initialize()
        {
            ...
            smith = new NPC(new Rectangle(300,300,52,72),blacksmith,new Rectangle(10,10,26,36),new Rectangle(100,100,200,200), new Vector2(0,0),true,'b', Speech.None, ran);
            shop = new NPC(new Rectangle(200, 300, 52, 72), Shopkeep, new Rectangle(0, 0, 26, 36), new Rectangle(400, 100, 200, 200), new Vector2(0, 0), true, 's', Speech.None,ran);
            priest = new NPC(new Rectangle(400, 300, 52, 72), priestT, new Rectangle(0, 0, 26, 36), new Rectangle(100, 400, 200, 200), new Vector2(0, 0), true, 'p', Speech.None, ran);
            armor = new NPC(new Rectangle(300, 400, 52, 72), armourer, new Rectangle(26 * 3, 0, 26, 36), new Rectangle(400, 400, 200, 200), new Vector2(0, 0), true, 'a', Speech.None, ran);
